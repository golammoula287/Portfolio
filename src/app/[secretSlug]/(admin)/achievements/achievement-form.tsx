    ...
    <form action={formAction}>
      <FieldGroup>
        ...
        <Field data-invalid={!!errors.issuer}>
          ...
          <Input id="issuer" name="issuer" defaultValue={defaultValues?.issuer} required />
        ...
        <Field data-invalid={!!errors.date}>
          ...
          <Input id="date" name="date" type="date" defaultValue={toDateInputValue(defaultValues?.date)} required />
          <FieldError errors={errors.date?.map((message) => ({ message }))} />
        </Field>

        <Field data-invalid={!!errors.url}>
          <FieldLabel htmlFor="url">URL</FieldLabel>
          <Input id="url" name="url" type="url" defaultValue={defaultValues?.url ?? undefined} />
